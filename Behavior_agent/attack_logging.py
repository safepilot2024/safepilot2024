...
def attlogger(mission_id, mission_result, mission_setup, mission_duration, victim_car_details, attacker_car_details, attack_commands, rewinding_details=None, collision_obj=None ):
    '''
    ...
    if mission_result:
        file_name =  "/home/test/文档/CarlaData001/" + mission_id + "/log/success/" + file_name + ".json"
    else:
        file_name =  "/home/test/文档/CarlaData001/" + mission_id + "/log/failure/" + file_name + ".json"
